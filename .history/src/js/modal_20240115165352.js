        ...
        if (movieId) {
          try {
            ...
            <div class="movie-details">
              ...
              <p><span class="categ">Vote / Votes </span><span>${movieData.votes}</span></p>
              <p><span class="categ">Popularity</span><span>${movieData.popularity}</span></p>
              <p class="title"><span class="categ">Original Title</span><span>${movieData.title}</span></p>
              <p><span class="categ">Genre</span><span>${movieData.genre}</span></p>
              <p>ABOUT</p>
